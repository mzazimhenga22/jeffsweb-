...
export default function VendorSalespersonsPage() {
  ...
  const handleDeleteConfirm = () => {
    if (selectedSalesperson) {
      ...
      toast({ variant: 'destructive', title: "Salesperson Removed", description: `${selectedSalesperson.name} has been removed.` });
                  ...
                  <TableCell className="text-right">
                    <DropdownMenu>
                      ...
                      <DropdownMenuContent align="end">
                        ...
                        <DropdownMenuItem onClick={() => toast({ title: 'Viewing details for ' + user.name })}>View Details</DropdownMenuItem>
